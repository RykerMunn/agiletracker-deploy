    ...
    try {
            ...
            validator: {
                $jsonSchema: {
                    ...
                    properties: {
                        ...
                        userid: {
                            bsonType: "objectId",
                            description: "UserId for username who created project is required."
                        },
                        tasks: {
                            bsonType: "object",
        ...
        await db.createCollection(process.env.TASKCOLLECTION, {
            validator: {
                $jsonSchema: {
                    bsonType: "object",
                    required: ["username", "userid", "members", "taskIsComplete", "estimatedTime", "actualTime", "details"],
                    properties: {
                        username: {
                            bsonType: "string",
                            description: "Username<string> is a required field."
                        ...
                        userid: {
                            bsonType: "objectId",
                            description: "The field used to relate username to the userId is required"
                        },
                        members: {
                            bsonType: "object",
